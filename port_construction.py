...
class HRP(object):
    ...
    def plot_corr_matrix(self, save_path=None, show_chart=True, cmap='vlag', linewidths=0, figsize=(6, 6),
...
class MinVar(object):
    ...
    def __init__(self, data):
        ...
        bounds = ((0.0, 1.0),) * len(self.cov.index)
        
        res = minimize(self._port_var, w0, method='SLSQP', bounds=bounds, constraints=eq_cons,
